...
TYPE
  ...
  MTProfilePosGenInternalType : 	STRUCT  (*Internal variables of function block MTProfilePositionGenerator.*)
    ...
    JoltTimeMax : LREAL; (*Data for internal use.*)
    ...
    StatusVariables : MTProfilePosGenStateVarType; (*Data for internal use.*)
  END_STRUCT;
  MTProfilePosGenStateVarType : 	STRUCT  (*Defines status of the FB, trigger variables.*)
  ...
  MTProfileFcnGenInternalType : 	STRUCT  (*Internal variables of function block MTProfileFcnGenerator.*)
    ...
    StatusVariables : MTProfileFcnGenStateVarType; (*Data for internal use.*)
  END_STRUCT;
  MTProfileFcnGenStateVarType : 	STRUCT  (*Defines status of the FB, trigger variables.*)
    ParametersValid : BOOL; (*Data for internal use.*)
    UpdateOld : BOOL; (*Data for internal use.*)
    EnableOld : BOOL; (*Data for internal use.*)
  END_STRUCT;
